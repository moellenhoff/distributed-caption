...
Works on **CUDA** (Linux), **MPS** (Apple Silicon), and **CPU**.
...
Workers (Mac Studios, Linux machines, any number)
...
### 2 — Workers (macOS / Mac Studio / Linux)
...
**Workers:** Python 3.11, PyTorch (MPS/CUDA/CPU), Transformers ≥ 4.40, tensorflow, ~50 GB disk (14 GB model + 32 GB tensorflow on Apple Silicon)
